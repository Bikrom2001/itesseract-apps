          ...
          <div className="container mx-auto">
            <div className="text-center lg:w-[640px] mx-auto w-full">
              ...
              <p className='mb-6'>
                ...
                creates answers to common challenges in order to improve the
                world. iTesseract is focused on the ideal of influencing and
                empowering social life via the use of cutting-edge technology.
              </p>
            </div>
          </div>
        </section>
