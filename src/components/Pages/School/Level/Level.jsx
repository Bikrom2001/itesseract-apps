      ...
      <section className="p-4 lg:p-8 ">
        <div className="container mx-auto space-y-12">
          <div className="flex flex-col overflow-hidden gap-10  lg:flex-row">
            <div>
              <h2 className="text-4xl font-bold">Learning Path</h2>
              <p className=" mt-2 dark:text-gray-500">
                Each Level have 12 Lesson
              </p>
            </div>
            <div className="flex flex-col  flex-1">
              <p className=" dark:text-gray-500 text-justify">
                There are levels of courses, carefully planned and aligned with
                the technical contents. Technical contents like introduction to
                programming language, IoT, AI and robotics. Now these terms may
                seem very difficult but our course contents are age appropriate
                for every level, our methodology of teaching is mainly STEM
                which allows hands-on learning through gamification, no-homework
                based learning. We have 6 Levels in our Learning Path, which is
                appropriately planned and designed to have the exact outcome of
                mastering the skills that are required for becoming a highly
                technical Engineer, Educator, Researcher, etc in the future.
              </p>
            </div>
          </div>
        </div>
